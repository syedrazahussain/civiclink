...
const RegisterAdmin = () => {
    ...
    const handleForm = async (e) => {
        e.preventDefault()
        try {
            const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/v1/admin/adminregister`, { name, email, phone, password, confirmpassword })
            if (res.data.success) {
                message.success('Admin Register Successfully')
                ...
                <div className="login">
                    ...
                    <form onSubmit={handleForm}>
                        ...
                        <div className="signup">
                            <p> I have account <Link to="/AdminLoginPage">Login </Link> </p>
                        </div>
